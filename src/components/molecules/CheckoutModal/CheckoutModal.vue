<template>
  ...
  >
    <div class="bg-white py-10 rounded-md w-[90%] mx-auto z-40 h-max mt-10">
      <div class="w-[90%] mx-auto">
        ...
        <div>
          <div class="bg-grey py-4 rounded-tl-xl rounded-tr-xl">
            <div class="w-[90%] mx-auto">
              <cart-item
                v-bind="cartItem"
              >
          ...
          <div class="bg-black py-4 rounded-bl-xl rounded-br-xl">
